 ...
 * 
 * @WebServlet 어노테이션
 * -> 해당 클래스를 Servlet 으로 등록하고 () 안에 자것ㅇ된 주소와
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		// -> JSP 가 대신 화면을 만들어달라!
		// -> Servlet이 JSP 에게 요청/응답을 위임
		// JSP가 대신 응답화면을 만들어주기 위해서는
		// Servlet 이 어떤 요청을 받았는지 알아야한다(req, resp)
		...
		// WEB-INF 폴더에 있는 파일들은 클라이언트가 url 로 직접 접근할 수 없는 영역,
		// 서블릿을 통해서만 접근 가능
		...
		// result.jsp 로 전달하고 제어권을 그곳으로 넘김(== 위임하다)
